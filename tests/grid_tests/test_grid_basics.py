...
class TestGridSolver:
    ...
    @pytest.mark.parametrize("base,expected", [
        (
                ...
                | 358 13589 2    | 589  6    89   | 34789 134789 38    |
                +----------------+----------------+--------------------+
                | 38  7     1358 | 2389 238  289  | 19     6      45   |
                | 24  6     24   | 3589 1    7    | 389   3589   358   |
                | 9   38    15   | 4    2358 6    | 238   2358   7     |
                +----------------+----------------+--------------------+
                """,
                ...
                r"""
                +----------------+----------------+--------------------+
                | 7   25    6    | 1    238  58   | 2348  2348   9     |
                | 38  25    38   | 6    9    4    | 27    57     1     |
                | 1   4     9    | 238  7    28   | 6     2358   2358  |
                +----------------+----------------+--------------------+
                | 6   189   7    | 289  4    3    | 5     1289   28    |
                | 45  3589  358  | 7    258  1    | 2389  2389   6     |
    ...
    def test_pairs(self, base, expected):
        grid = Grid.text_to_grid(base)
        assert not grid.pairs_solve(cells = grid.row(7))
        assert grid == base
    ...
    def test_triplets(self):
        ...
        expected = r"""
            ...
            """
        grid = Grid.text_to_grid(base)
        assert grid.triples_solve()
        expected = Grid.text_to_grid(expected)
        assert str(grid) == str(expected)
