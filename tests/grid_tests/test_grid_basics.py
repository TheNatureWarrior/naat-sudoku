...
class TestGridSolver:
    ...
    def test_hidden_single_solve(self):
        ...
        expected = r"""
            +----------------+----------------+--------------------+
            | 7   38    6    | 1    238  5    | 2348  2348   9     |
            | 5   2     38   | 6    9    4    | 378   378    1     |
            | 1   4     9    | 238  7    28   | 6     2358   2358  |
            +----------------+----------------+--------------------+
            | 6   189   7    | 289  4    3    | 5     1289   28    |
            | 4   3589  38   | 7    258  1    | 2389  2389   6     |
            | 38  13589 2    | 589  6    89   | 34789 134789 38    |
            +----------------+----------------+--------------------+
            | 38  7     5    | 2389 238  289  | 1     6      4     |
            | 2   6     4    | 3589 1    7    | 389   3589   358   |
            | 9   38    1    | 4    2358 6    | 238   2358   7     |
            ...
            """
        grid = Grid.text_to_grid(base)
        assert grid.hidden_single_solve()
        assert grid == expected
    ...
    def test_pairs(self):
        ...
        | 1   4     9    | 238  7    28   | 6     2358   2358  |
        +----------------+----------------+--------------------+
        | 6   19    7    | 289  4    3    | 5     1289   28    |
        | 4   59    38   | 7    258  1    | 2389  2389   6     |
        | 358 159   2    | 589  6    89   | 34789 134789 38    |
        +----------------+----------------+--------------------+
        | 38  7     5    | 2389 238  289  | 1     6      4     |
        | 2   6     4    | 3589 1    7    | 389   3589   358   |
        | 9   38    1    | 4    2358 6    | 238   2358   7     |
    ...
    def test_hidden_pairs(self):
        ...
        """
        grid = Grid.text_to_grid(base)
        assert grid.hidden_pairs_solve()
        assert grid == expected
